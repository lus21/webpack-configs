...
/******/ 	var hotCurrentHash = "3e3065b970e00523fcf4"; // eslint-disable-line no-unused-vars
...
function increment() {
	...
	h1.innerHTML = ++_storage2.default.clicks;
}
...
__webpack_require__("./src/styles/index.less");
...
if (true) {
    module.hot.accept("./src/app.js", function () {
        try {
            ...
            comp = component();
            console.log(comp, _app2.default);
            document.body.appendChild(comp);
        } catch (err) {
            console.error(err);
        }
